 ...
 */
public class DifferentDrive extends RobotDriveBase {
   ...
   */
  public DifferentDrive(TalonSRX leftMotor, TalonSRX rightMotor) {
    m_leftMotor = leftMotor;
    m_rightMotor = rightMotor;
    addChild(m_leftMotor);
    addChild(m_rightMotor);
    instances++;
    setName("DifferentDrive", instances);
  }
...
//    m_rightMotor.set(-rightSpeed * m_maxOutput);
  ...
  public String getDescription() {
    return "DifferentDrive";
  }

  @Override
  public void initSendable(SendableBuilder builder) {
    builder.setSmartDashboardType("DifferentDrive");
