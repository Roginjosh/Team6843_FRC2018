 ...
 *
 */
public class DistDrive115_5 extends Command {

	protected final DriveSubsystem driveSubsystem;
	protected OI oi;
	
    public DistDrive115_5() {
    ...
    protected boolean isFinished() {
			if(this.driveSubsystem.getLeftPosition() >= 115.5  && this.driveSubsystem.getRightPosition() >= 115.5) {
    				return true;
    			} else {
    				return false;
    			}
